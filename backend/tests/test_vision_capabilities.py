...
def test_openai_sub_defaults_to_vision_for_non_vision_modalities_metadata() -> None:
    repo = _StubSettingsRepo()
    raw = {"capabilities": ["text"]}

    assert model_has_vision("openai-sub", "gpt-5.3-codex", repo, raw_model=raw) is True
